<template>
  <div class="book-home">
    ...
    <div
      ...
      v-show="!ifShowSearchPage || !ifShowHotSearch"
      ref="bookListWrapper"
    >
...
export default {
  ...
  mounted() {
    ...
    this.$refs.bookListWrapper.style.height =
      window.innerHeight - realPx(52) + 'px'
    this.$refs.bookListWrapper.addEventListener(
      'scroll',
      this.handleBookListScroll
    )
